...
module.exports = "<h1 class=\"animated fadeIn fast\">Sobre Comic APP</h1>\n<hr>\n<p class=\"fadeIn\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque, eaque ipsa magnam molestias repellat repellendus repudiandae rerum saepe ullam ut vitae voluptas voluptatibus? Adipisci cumque exercitationem incidunt iusto neque quo?</p>"
...
module.exports = "<h1>{{ hero.nombre | uppercase }} <small>({{ hero.aparicion | date:'y' }})</small></h1>\n<hr>\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <img [src]=\"hero.img\" class=\"img-fluid\" alt=\"\">\n    <br><br>\n    <a [routerLink]=\"['/heroes']\" class=\"btn btn-primary btn-block\">Regresar</a>\n  </div>\n  <div class=\"col-md-8\">\n    <h3>{{ hero.nombre }}</h3>\n    <hr>\n    <p>{{ hero.bio }}</p>\n    <div>\n      <img *ngIf=\"hero.casa == 'Marvel'\" src=\"./assets/img/marvel.png\" alt=\"{{ hero.nombre }}\">\n      <img *ngIf=\"hero.casa == 'DC'\" src=\"./assets/img/dc.png\" alt=\"{{ hero.nombre }}\">\n    </div>\n  </div>\n</div>"
...
var HeroComponent = /** @class */ (function () {
    function HeroComponent(activatedRoute, heroesService) {
        var _this = this;
        this.activatedRoute = activatedRoute;
        this.heroesService = heroesService;
        this.hero = {};
        this.activatedRoute.params.subscribe(function (params) {
            _this.hero = _this.heroesService.getHero(params.id);
        });
    }
...
var HeroesComponent = /** @class */ (function () {
    ...
    HeroesComponent.prototype.showHero = function (id) {
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-light bg-light\">\n  <a class=\"navbar-brand\" href=\"#\">\n    <img src=\"./assets/img/A-64.png\" width=\"30\" height=\"30\" alt=\"\">\n  </a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n  \n  <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\" routerLinkActive=\"active\">\n        <a class=\"nav-link\" [routerLink]=\"['home']\">Home</a>\n      </li>\n      <li class=\"nav-item\" routerLinkActive=\"active\">\n        <a class=\"nav-link\" [routerLink]=\"['heroes']\">Heroes</a>\n      </li>\n      <li class=\"nav-item\" routerLinkActive=\"active\">\n        <a class=\"nav-link\" [routerLink]=\"['about']\">About</a>\n      </li>\n    </ul>\n    <div class=\"form-inline my-2 my-lg-0\">\n      <input class=\"form-control mr-sm-2\" type=\"text\" placeholder=\"Buscar héroe...\" (keyup)=\"searchHero(searchText.value)\" #searchText>\n      <button (click)=\"searchHero(searchText.value)\" class=\"btn btn-outline-success my-2 my-sm-0\" type=\"button\">Buscar</button>\n    </div>\n  </div>\n</nav>"
...
var HeroesService = /** @class */ (function () {
    ...
    HeroesService.prototype.searchHeroes = function (text) {
        var heroesArray = [];
        text = text.toLowerCase();
        for (var _i = 0, _a = this.heroes; _i < _a.length; _i++) {
            var hero = _a[_i];
            var name_1 = hero.nombre.toLowerCase();
            if (name_1.indexOf(text) >= 0) {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\www\angular\02-spa\src\main.ts */"./src/main.ts");
